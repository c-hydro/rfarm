...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RFARM RUNNER - WRF - REALTIME'
script_version="1.5.2"
script_date='2019/10/14'

# SERVER
script_folder='/share/c-hydro/rfarm-dev/'
...
setting_file='/home/fabio/Desktop/PyCharm_Workspace/rfarm-dev/apps/rfarm_configuration_wrf_realtime.json'
