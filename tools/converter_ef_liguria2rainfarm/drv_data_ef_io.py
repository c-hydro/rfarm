...
from lib_ef_analysis import find_slopes
from lib_ef_conventions import conventions_vars

from lib_ef_io_generic import write_obj, read_obj, read_file_csv, \
    save_file_json, create_default_dframe
from lib_ef_generic import make_folder, fill_tags2string, list_folder, \
