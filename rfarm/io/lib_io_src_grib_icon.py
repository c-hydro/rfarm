...
# -------------------------------------------------------------------------------------
# Method to adjust icon 2i datasets
def adjust_data_icon_2i(da_var, da_time, da_geo_x, da_geo_y,
...
# -------------------------------------------------------------------------------------
# Method to read data for icon-2i
def read_data_icon_2i(file_name, data_filters=None, data_var='tp',
                      tag_var_time='valid_time', tag_var_geo_x='longitude', tag_var_geo_y='latitude',
    ...
    var_geo_x_step, var_geo_y_step = np.meshgrid(var_geo_x, var_geo_y)
    ...
    for step in range(0, var_values.shape[0]):
        ...
        tmp_values = griddata((var_geo_x_step.ravel(), var_geo_y_step.ravel()), step_values.ravel(),
